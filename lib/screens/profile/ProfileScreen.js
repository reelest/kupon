...
import { useSentPackages } from "../../logic/logistics";

export default function ProfileScreen({ navigation }) {
  const user = useUser();
  console.log("profile Screen");
  const theme = useTheme();
  const sentItems = useSentPackages().data;
                  ...
                  sentItems.map((e) => (
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        >
                          <Text variant="titleMedium">{e.packageName} </Text>
                          <Text
                            variant="bodyMedium"
                            style={{
